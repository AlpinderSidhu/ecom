...
public class ProductController {
    ...
    public HttpEntity<ProductDTO> updateProduct(@Valid @RequestBody ProductDTO productDTO,
    ...
    public HttpEntity<ProductDTO> deleteProduct(@PathVariable Long productId) {
